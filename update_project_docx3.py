...
def update_document():
    ...
    # Notice we REMOVED the "• " or "• " from the start of bullet points, 
    # since Word automatically adds the bullet point graphic.
    para_replacements = {
    ...
    print("Saved MY PROJECT.docx successfully with single bullets and restored headings.")
