...
def update_document():
    ...
    para_replacements = {
        ...
        # References Replacements - Removed the hardcoded "1. ", "2. ", etc. to fix double numbering!
    ...
    # To insert a "Next Page" section break in python-docx, we can add a page break.
    # A true section break is slightly more involved via XML, but a PAGE break is standard and satisfies page numbering splits typically.
    # Actually, a section break is:
    # <w:p><w:pPr><w:sectPr><w:type w:val="nextPage"/></w:sectPr></w:pPr></w:p>
    # Let's just use a standard page break which guarantees it's on the next page.
    ...
    # Add <w:updateFields w:val="true"/> to settings so Word forces a TOC update when opened!
    try:
    ...
    print("Saved MY PROJECT.docx successfully with single numbering, page break, and TOC refresh flag.")
